(function() {
  jQuery(function() {
    var $document, $nameReminder, $progressBar, $sectionNavigator, $sections, $titleArea, $window, articleHeight, articleOffset, checkProgress, docHeight, infiniteScroll, init, nanobar, setAbstractListeners, throttledProgress, titleAreaBottom;
    $window = $(window);
    $document = $(document);
    init = function() {
    ...
    infiniteScroll = function() {
      if ($('.pagination').length && !$('body').hasClass('editors')) {
